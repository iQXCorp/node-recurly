  ...
  module.exports = function(config){
    ...
    this.accounts = {
      ...
      create: function(details, callback){
        t.request(routes.accounts.create, calchrome-devtools://devtools/remote/serve_file/@521e5b7e2b7cc66b4006a8a54cb9c4e57494a5ef/inspector.html?experiments=true&v8only=true&ws=localhost:5859/nodelback, new Js2xml('account',details).toString());
      },
      ...
      balance: function(accountcode, callback){
        t.request(utils.addParams(routes.accounts.balance, {account_code: accountcode}), callback)
      }
    }
